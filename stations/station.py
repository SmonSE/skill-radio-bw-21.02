...
stations = dict(
    #Podcast
    SWR3P=RSSStation('SWR3', 'SWR3 News', 
                   'https://www.swr3.de/~podcast/aktuell/topthema/index.xml', None),
    BAY=RSSStation('BAY', 'Baywatch Berlin', 
                  'https://baywatch-berlin.podigee.io/feed/mp3', None),
    WWV=RSSStation('WWV', 'Wo Wir Sind Ist Vorne',
                  'feed:https://wowirsindistvorne.show/feed/mp3/', None),
    GDT=RSSStation('GDT', 'Gag des Tages',
                  'https://www.swr3.de/~podcast/comedy/gag-des-tages/index.xml', None),
    ...
    SWR3R=FileStation('SWR3', 'SWR3 Radio',
