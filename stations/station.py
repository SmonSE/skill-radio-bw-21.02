...
stations = dict(
    ...
    RGB=FileStation('REGNBGN', 'REGENBOGEN', 'https://streams.regenbogen.de/rr-mannheim-128-mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Radio_Regenbogen.svg/262px-Radio_Regenbogen.svg.png'),

    SWR3=FileStation('SWR3', 'SWR3 Radio', 'https://liveradio.swr.de/sw282p3/swr3/play.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Swr3-logo.svg/320px-Swr3-logo.svg.png'),

    SWR1R=FileStation('SWR1', 'SWR1 BW Radio', 'https://liveradio.swr.de/sw282p3/swr1bw/play.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/SWR1_BW_rechts_Logo.svg/320px-SWR1_BW_rechts_Logo.svg.png'),

    DNW=FileStation('DNW', 'Die neue Welle', 'http://dieneuewelle.cast.addradio.de/dieneuewelle/simulcast/high/stream.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Die_neue_welle_2008.svg/263px-Die_neue_welle_2008.svg.png'),

    SHL=FileStation('sunshine', 'sunshile live', 'http://stream.sunshine-live.de/hq/mp3-128', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Sunshine_live_logo.svg/320px-Sunshine_live_logo.svg.png'),

    SWR4S=FileStation('SWR4 S', 'SWR4 Stuttgart', 'http://swr-swr4-bw.cast.addradio.de/swr/swr4/bw/mp3/128/stream.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/SWR4_Baden-Württemberg_Logo.svg/320px-SWR4_Baden-Württemberg_Logo.svg.png'),

    SWR4K=FileStation('SWR4 KA', 'SWR4 Karlsruhe', 'http://swr-swr4-ka.cast.addradio.de/swr/swr4/ka/mp3/128/stream.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Swr4-logo.svg/320px-Swr4-logo.svg.png'),

    ANT=FileStation('antenne1', 'antenne 1', 'http://stream.antenne1.de/a1stg/livestream2.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Antenne_1_Logo.svg/272px-Antenne_1_Logo.svg.png'),

    RD7=FileStation('radio7', 'Radio 7', 'http://radio7server.streamr.ru:8040/radio7256.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Radio_7_logo.svg/320px-Radio_7_logo.svg.png'),

    SWR2=FileStation('swr2', 'SWR 2', 'https://liveradio.swr.de/sw331ch/swr2', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/5/53/SWR2_Logo_bis_2014.png'),

    ENY=FileStation('energy', 'Energy Stuttgart', 'http://media.mediatime.ru:8051/Energy', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Energy_Bern_Logo.png/301px-Energy_Bern_Logo.png'),

    #BAD=FileStation('baden.fm', 'Baden FM', 'http://badenfm.ip-streaming.net:8006/badenfm', 'None', 'None', 'None'),

    EPR=FileStation('europa-park', 'Europa-Park Radio', 'https://rs9.stream24.net/europa-park-radio.mp3', 'None', 'None', 'https://blog.europapark.de/wp-content/uploads/2020/04/91610789_10156930933991440_1215580584919695360_n.jpg'),   

    SEE=FileStation('seefunk', 'Radio Seefunk', 'http://webradio.radio-seefunk.de:8000/live64', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/RADIO_SEEFUNK.svg/240px-RADIO_SEEFUNK.svg.png'), 

    BHH=FileStation('bigFM Hip Hop', 'big FM Hip Hop', 'http://streams.bigfm.de/bigfm-dhiphopcharts-128-mp3', 'None', 'None', 'https://www.phonostar.de/images/auto_created/bigfm_hiphop4184x184.png'),  

    BHC=FileStation('bigFM Charts', 'big FM Charts', 'http://ilr.bigfm.de/bigfm-charts-128-mp3', 'None', 'None', 'https://www.phonostar.de/images/auto_created/bigfm_charts4184x184.png'), 

    RLR=FileStation('Rockland', 'Rockland Radio', 'http://stream.rockland.de/rockland.mp3', 'None', 'None', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Rockland_Radio_Logo.jpg/320px-Rockland_Radio_Logo.jpg'), 
